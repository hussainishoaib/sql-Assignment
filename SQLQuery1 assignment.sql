...
( 'La corne dabondance', 'Daniel Tonini', '67, avenue de lEurope', 'Versailles', '78000', 'France'),
...
( 'Gday, Mate', 'Wendy Mackenzie', '170 Prince Edward Parade Hunters Hill', 'Sydney', '2042', 'Australia', '(02) 555-5914'),
...
( 'Forêts dérables', 'Chantal Goulet', '148 rue Chasseur', 'Ste-Hyacinthe', 'J2S 7S8', 'Canada', '(514) 555-2955');
...
( 'Grandmas Boysenberry Spread', 3, 2, '12 - 8 oz jars', 25),
...
( 'Sir Rodneys Marmalade', 8, 3, '30 gift boxes', 81),
( 'Sir Rodneys Scones', 8, 3, '24 pkgs. x 4 pieces', 10),
( 'Gustafs Knäckebröd', 9, 5, '24 - 500 g pkgs.', 21),
...
( 'Jacks New England Clam Chowder', 19, 8, '12 - 12 oz cans', 9.65),
...
( 'Sirop dérable', 29, 2, '24 - 500 ml bottles', 28.5),
...
select * from suppliers where city = 'osaka' or country = 'japan';
select * from products where ProductName like ('c%') and price <20;
select * from products where price between 20 and 31;
select * from products where Price in(35,45,63,263); 
select *from employees where FirstName = 'nancy'or FirstName = 'adam';
--select *from employees where FirstName in('nancy','adam');
